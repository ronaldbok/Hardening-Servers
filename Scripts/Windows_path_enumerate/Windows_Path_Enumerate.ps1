...
Param (
    ...
    [parameter(Mandatory = $False,
        ParameterSetName = "Restoring")]
        [string]$BackupFolderPath = "$logdir\Scripts\Windows_path_enumerate\PathEnumerationBackup",

    [parameter(Mandatory = $False,
        ParameterSetName = "Fixing")]
    [parameter(Mandatory = $False,
        ParameterSetName = "Restoring")]
        [string]$LogName = "c:\temp\Scripts\Windows_path_enumerate\log\ServicesFix-3.5.1.Log",
...
Function Fix-ServicePath {
    ...
    Param (
        ...
        [Switch]$FixEnv,
        [Switch]$Backup,
        [string]$BackupFolder = "$logdir\Scripts\Windows_path_enumerate\PathEnumerationBackup",
        [Switch]$WhatIf,
        [Switch]$Passthru
    )
